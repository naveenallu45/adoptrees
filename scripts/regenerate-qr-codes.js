...
async function main() {
  try {
    ...
    console.log(`[MIGRATION] Regenerating ALL QR codes to ensure they use https://adoptrees.com`);
    ...
    while (true) {
      ...
      for (const user of users) {
        try {
          // Always regenerate QR code to ensure it uses https://adoptrees.com
          // We can't reliably detect localhost in base64-encoded QR images
          // eslint-disable-next-line no-await-in-loop
