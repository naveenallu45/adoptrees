...
export async function POST(req: NextRequest) {
  try {
    ...
    // Generate and store QR code for the user (MUST match publicId)
    ...
    try {
      ...
      // Update user with QR code (immutable after this)
      user.qrCode = qrDataUrl;
      await user.save();
    } catch (qrError) {
      // QR code generation failure should fail registration since it's required
