      ...
      {!isTransactionsPage && (
        ...
        >
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">{stats.thisMonthTrees}</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600">Oxygen Produced</p>
              <p className="text-2xl font-bold text-gray-900">{stats.totalOxygen.toFixed(1)} kg</p>
            </div>
          </div>
        </motion.div>
        </div>
