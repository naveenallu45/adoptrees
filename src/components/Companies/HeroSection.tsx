      ...
      <div className="relative z-20 min-h-[50vh] sm:min-h-[60vh] md:min-h-[60vh] flex items-center justify-center pt-8 sm:pt-12 md:pt-14 lg:pt-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold text-white mb-6 sm:mb-8 drop-shadow-2xl tracking-tight">
            <span className="block mb-3 bg-gradient-to-r from-white via-blue-100 to-indigo-100 bg-clip-text text-transparent">
              For Companies
            </span>
            <span className="block text-blue-300 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-light mt-4">
          ...
          <div className="flex items-center justify-center mb-8 sm:mb-10">
            ...
            <div className="mx-4 w-2 h-2 rounded-full bg-blue-400"></div>
            <div className="w-24 h-1 bg-gradient-to-r from-transparent via-blue-400 to-transparent"></div>
          </div>
